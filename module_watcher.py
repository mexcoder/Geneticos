...
class ModuleWatcher(pyinotify.ProcessEvent):
    ...
    def _watch_file(self, file_name, module):
        ...
        self.wd_map[file_name] = self.wm.add_watch(file_name, pyinotify.EventsCodes.IN_MODIFY)
        #print 'Watching', file_name
    
    def remove_watches(self):
        for filename, wd in self.wd_map.values:
            self.wm.remove_watches(wd)
